function mainmenu
{
    ...
    Write-Host "1: Area of Square" -ForegroundColor White
    Write-Host "2: Area of Rectangle" -ForegroundColor Magenta
    Write-Host "3: Area of Circle" -ForegroundColor Red
    Write-Host "4: Area of Triangle" -ForegroundColor Cyan
    Write-Host "5: Exit`n" -ForegroundColor Blue
...
function rectangle
{
    ...
    [int]$breadth = Read-Host "Enter witdh of the rectangle"
    $area = $length * $breadth
